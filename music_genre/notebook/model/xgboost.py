...
def xgboost(*, path_to_log_csv=None, author=None, df=None, df_test=None, name="XGBClassifier", name_folder='newFE_folder', name_feature='newFe', print_log=True, save_log=False, save_model=False, save_submission=False):
    ...
    fold_index = 1
    model = XGBClassifier(random_state=42, n_estimators=300, eval_metric='logloss')
