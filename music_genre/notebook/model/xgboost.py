...
def xgboost(*, path_to_log_csv=None, author=None, df=None, df_test=None, name="XGBClassifier", name_folder='newFE_folder', name_feature='newFe', save_log=False, save_model=False, save_submission=False):
