...
def catboost(*, path_to_log_csv = None, author=None, df=None, df_test=None, name="CatBoostRegressor", name_folder='newFE'):
    ...
    model_path = join(model_dir, name + f"_{name_folder}.pkl")
