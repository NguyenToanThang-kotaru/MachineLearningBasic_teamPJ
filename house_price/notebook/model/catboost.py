...
def catboost(*, path_to_log_csv=None, author=None, df=None, df_test=None, name="CatBoostRegressor", name_folder='newFE', save_log=False, save_model=False, save_submission=False):
